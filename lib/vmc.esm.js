import { openBlock, createBlock, Transition, withCtx, withDirectives, createElementVNode, normalizeStyle, renderSlot, vShow, reactive, shallowReactive, h } from 'vue';
  ...
  return (openBlock(), createBlock(Transition, {
    ...
    default: withCtx(() => [
      withDirectives(createElementVNode("div", {
        ...
        style: normalizeStyle($data.containerClass),
